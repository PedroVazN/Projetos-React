  ...
  return (
    <div className="carrinho">
      ...
      <div className="carrinho-lista">
        {/* Usando o método map para gerar dinamicamente elementos para cada produto no carrinho. */}
        {carrinho.map((produto, index) => (
          <div key={index} className="carrinho-item">
            <p>{produto.nome} - R${produto.preco.toFixed(2)}</p>
            {/* Botão "Remover" que chama a função removerProduto com o índice do produto como argumento. */}
